...
bool TestLogRecordExporter::ForceFlush(std::chrono::microseconds /*timeout*/) noexcept {
  return true;
}

bool TestLogRecordExporter::Shutdown(std::chrono::microseconds /*timeout*/) noexcept {
  return true;
}
